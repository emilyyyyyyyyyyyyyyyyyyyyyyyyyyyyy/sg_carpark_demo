...
def head():
    ...
    st.caption("""
        ...
        by <a href='https://github.com/emilyyyyyyyyyyyyyyyyyyyyyyyyy'>emilyyyyyyyyyyyyyyyyyyyyyyyyy</a>
    ...
    st.write(f"<p style='text-align: left; color:Black'> Current Date Time: {now_modifed}</p>", unsafe_allow_html=True)
